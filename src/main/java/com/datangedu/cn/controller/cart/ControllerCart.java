...
//		providerProductInfo.add((ProviderProduct)providerProductService.getid(id));
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping(value="/hhh",method=RequestMethod.POST) public
	 * Map<String,Object> Productzhifu(HttpServletRequest request) {
	 * Map<String,Object> map=new HashMap<String,Object>();
	 * if(Integer.valueOf(request.getParameter("paytype"))!=0) {
	 * 
	 * int a = serviceOrderService.up(request); map.put("code", 1); map.put("msg",
	 * "支付成功"); return map; } map.put("msg", "请选择支付方式"); return map;
	 * 
	 * }
	 */
	...
	public Map<String, Object> Productxiangqing2(HttpServletRequest request) {
		Map<String, Object> map = new HashMap<String, Object>();
		List<ServiceOrder> soList = serviceOrderService.search(request);
/////////////////////////////////////////////
